...
class MonthSpinnerAdapter(var activity: AppCompatActivity, var dataList: ArrayList<DateTimeModel>) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        tvDashboardSpinner.text = dataList[position].monthInFullString
        return view
    }
