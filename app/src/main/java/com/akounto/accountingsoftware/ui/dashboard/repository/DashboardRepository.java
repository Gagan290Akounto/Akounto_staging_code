...
public class DashboardRepository {
    ...
    public MutableLiveData<SearchDashboardData> loadSearch(Context mContext) {
        ...
        api.searchDashboard(Constant.X_SIGNATURE, "Bearer " + UiUtil.getAcccessToken(mContext),
                UiUtil.getComp_Id(mContext)).enqueue(new Callback<SearchDashboardData>() {
            @Override
    ...
    /*public MutableLiveData<DashboardData> loadDashboard(Context mContext, JSONObject request) {
        ...
        Api api = ApiUtils.getAPIService();
        api.getDashboard(Constant.X_SIGNATURE, UiUtil.getComp_Id(mContext),
                "Bearer " + UiUtil.getAcccessToken(mContext), request)
    ...
    public MutableLiveData<DashboardData> loadDashboard(Context mContext, GetDashboardRequest request) {
